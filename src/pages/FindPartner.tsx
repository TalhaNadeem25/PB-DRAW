    ...
    <Layout>
      <div className="min-h-screen">
        ...
        <section className="relative py-16 overflow-hidden">
          ...
          <div className="absolute bottom-10 right-20 w-48 h-48 bg-accent/30 rounded-full blur-3xl animate-float-delayed" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">
                Partner <span className="text-gradient">Matchmaking</span>
              </h1>
            ...
            >
              <TabsList className="grid grid-cols-2 w-full max-w-md mx-auto mb-8 glass">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {players.map((player) => (
                      <Card 
                        key={player._id} 
                        className={cn(
                          "glass-card hover:-translate-y-1 transition-all duration-300 group",
