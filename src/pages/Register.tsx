      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="bg-hero-gradient py-12 relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-1/2 right-1/3 w-32 h-32 bg-primary-foreground/10 rounded-full blur-2xl animate-float" style={{ animationDelay: "3s" }} />
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              <div className="animate-fade-in">
                <Badge className="bg-secondary text-secondary-foreground mb-4 shadow-glow-yellow">
                  Event Registration
                </Badge>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="glass-card border-border/50 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Select events to register for (click to select, click again to deselect)
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {events.length === 0 ? (
                        ...
                        return (
                          <div
                            ...
                            className={`p-5 rounded-xl border-2 transition-all duration-300 ${
                              ...
                              isSelected ? 'border-primary bg-primary/5 shadow-glow' : 'border-border/50 hover:border-primary/30 glass'
                            }`}
                          >
            ...
            <div className="space-y-6">
              {/* Shopping Cart */}
              <Card className="glass-card border-border/50 shadow-lg overflow-hidden sticky top-24">
                    ...
                    <>
                      <div className="space-y-3">
                        {selectedEvents.map((sel, idx) => (
                          <div key={sel.eventId} className="flex justify-between items-center p-3 glass rounded-lg">
                            <div className="flex items-center gap-2">
                              <CheckCircle2 className="w-4 h-4 text-primary" />
                              <span className="text-sm font-medium">{sel.event.name}</span>
                            </div>
                      ...
                      <div className="pt-4 border-t border-border/50">
                        ...
                        <Button
                          ...
                          className="w-full h-12 text-base shadow-glow hover:shadow-glow-lg transition-all duration-300"
                          variant="hero"
                        >
